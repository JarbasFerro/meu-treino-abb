export const translations = {
  pt: {
    ...
    plannedSets: "Séries previstas",
    firstCue: "Pista inicial",
    warmupTitle: "Aquecimento rápido",
    warmupBody: "2-3 minutos: mobilize articulações, pratique o primeiro padrão sem carga e prepare a respiração.",
    warmupStepOne: "Solte pescoço, ombros, quadris e tornozelos.",
    warmupStepTwo: "Faça 5 repetições fáceis do primeiro movimento.",
    warmupStepThree: "Expire, trave costelas sobre pelve e comece limpo.",
    warmupDone: "Aquecimento feito",
    skipWarmup: "Pular aquecimento",
    finishSummaryTitle: "Treino registrado",
    finishSummaryBody: "Você preservou o hábito de hoje. Próxima sessão pode ajustar carga ou energia.",
    sessionType: "Tipo",
    bestToday: "Melhor hoje",
    prCount: "Recordes",
    avgRpe: "RPE médio",
    timeToStart: "Tempo até começar",
    backToToday: "Voltar ao hoje",
    ...
    storagePersistent: "Local seguro",
    storageTemporary: "Local temporário",
    syncPending: "pendente",
    estimatedDuration: "Duração",
    equipmentLabel: "Equipamento",
    homeEquipment: "Banco + halteres",
    hotelEquipment: "Quarto + peso corporal",
    lastRelevantLoad: "Última carga",
    noPreviousLoad: "Sem registro",
    habitFallback: "Conta para o hábito",
    previousLoad: "Carga anterior",
    bestLoad: "Melhor carga",
    bestSets: "Melhor séries",
    prBadge: "Recorde",
    noteLabel: "Nota",
    notePlaceholder: "Ajustes, dor, técnica...",
    rpeLabel: "RPE",
    ownershipTitle: "Dados e backup",
    ownershipBody: "Seu treino fica primeiro neste dispositivo. Exporte backups ou CSV quando quiser.",
    exportJson: "Exportar JSON",
    exportCsv: "Exportar CSV",
    importJson: "Importar JSON",
    importConfirmTitle: "Importar backup?",
    importConfirmBody: "Isto substituirá os dados locais do perfil selecionado por este arquivo.",
    importInvalid: "Backup inválido. Exporte um novo JSON do Hybrid Fit e tente novamente.",
    importParseError: "Não foi possível ler este JSON.",
    storageLow: "Armazenamento baixo",
    updateAvailable: "Nova versão disponível",
    updateNow: "Atualizar",
    later: "Depois",
    safetyNote: "Pare ou modifique se houver dor. Use uma regressão quando a forma quebrar e procure orientação médica se estiver voltando após inatividade ou tiver preocupações de saúde.",
  ...
  en: {
    ...
    importConfirmBody: "This will replace local data for the selected profile with this file.",
  ...
  es: {
    ...
    plannedSets: "Series previstas",
    firstCue: "Primera clave",
    warmupTitle: "Calentamiento rápido",
    warmupBody: "2-3 minutos: prepara articulaciones, practica el primer patrón sin carga y activa la respiración.",
    warmupStepOne: "Mueve cuello, hombros, caderas y tobillos.",
    warmupStepTwo: "Haz 5 repeticiones fáciles del primer movimiento.",
    warmupStepThree: "Exhala, bloquea costillas sobre pelvis y empieza limpio.",
    warmupDone: "Calentamiento hecho",
    skipWarmup: "Saltar calentamiento",
    finishSummaryTitle: "Entrenamiento registrado",
    finishSummaryBody: "Mantuviste vivo el hábito de hoy. La próxima sesión puede ajustar carga o energía.",
    sessionType: "Tipo",
    bestToday: "Mejor hoy",
    prCount: "Récords",
    avgRpe: "RPE medio",
    timeToStart: "Tiempo hasta empezar",
    ...
    resetActionShort: "Reset",
    storagePersistent: "Local seguro",
    storageTemporary: "Local temporal",
    syncPending: "pendiente",
    estimatedDuration: "Duración",
    equipmentLabel: "Equipo",
    homeEquipment: "Banco + mancuernas",
    hotelEquipment: "Habitación + peso corporal",
    lastRelevantLoad: "Última carga",
    noPreviousLoad: "Sin registro",
    habitFallback: "Cuenta para el hábito",
    previousLoad: "Carga anterior",
    bestLoad: "Mejor carga",
    bestSets: "Mejor series",
    prBadge: "Récord",
    noteLabel: "Nota",
    notePlaceholder: "Ajustes, dolor, técnica...",
    rpeLabel: "RPE",
    ownershipTitle: "Datos y backup",
    ownershipBody: "Tu entrenamiento vive primero en este dispositivo. Exporta backups o CSV cuando quieras.",
    exportJson: "Exportar JSON",
    exportCsv: "Exportar CSV",
    importJson: "Importar JSON",
    importConfirmTitle: "¿Importar backup?",
    importConfirmBody: "Esto reemplazará los datos locales del perfil seleccionado con este archivo.",
    importInvalid: "Backup inválido. Exporta un JSON nuevo de Hybrid Fit e inténtalo de nuevo.",
    importParseError: "No se pudo leer este JSON.",
    storageLow: "Almacenamiento bajo",
    updateAvailable: "Nueva versión disponible",
    updateNow: "Actualizar",
    later: "Después",
    safetyNote: "Para o modifica si sientes dolor. Usa una regresión cuando la técnica se rompa y consulta a un profesional si vuelves tras inactividad o tienes dudas de salud.",
